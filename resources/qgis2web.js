...
map.getView().fit([11886273.808794, -694234.351376, 11898264.293021, -685115.810037], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Wilayah Perumahan Dekat Sekolah Di Jakarta</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (67 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'WebGIS sederhana untuk menampilkan wilayah perumahan dekat sekolah.';
            }
